...
public class EvaluationOnlyLocal {

	public static void main(String[] args) throws IOException {
		
		int truePositives = calculateTruePositives("/Users/cemsoyulmaz/desktop/KT Assignment 1/KT - Assignment 1/src/documents/candidates2-results.txt");
		System.out.println("Number of true positives: " + truePositives);
		int falsePositives = calculateFalsePositives("/Users/cemsoyulmaz/desktop/KT Assignment 1/KT - Assignment 1/src/documents/candidates2-results.txt");
		System.out.println("Number of false positives: " + falsePositives);
		int falseNegatives = calculateFalseNegatives("/Users/cemsoyulmaz/desktop/KT Assignment 1/KT - Assignment 1/src/documents/candidates2-results-not-found.txt");
		System.out.println("Number of false negatives: " + falseNegatives);
		int trueNegatives =calculateTrueNegatives("/Users/cemsoyulmaz/desktop/KT Assignment 1/KT - Assignment 1/src/documents/candidates2-results-not-found.txt", falseNegatives);
